...
add_shields = function() {
  ...
  version = paste0("[![Package version](https://img.shields.io/badge/GitHub-",desc$Version,"-orange.svg)](",github,")")
  ...
  last_update = paste0("[![last_update](https://img.shields.io/badge/last%20update-",
                       format(Sys.Date(), dformat) %>% str_replace_all("-","--"),"-blue.svg)](",github,")")
